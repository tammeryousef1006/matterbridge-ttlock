...
const AccessControl = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Changed", id: 0, conformance: "M", description: "Entry or extension was changed" }),
    (0, import_elements.FieldElement)({ name: "Added", id: 1, conformance: "M", description: "Entry or extension was added" }),
    (0, import_elements.FieldElement)({ name: "Removed", id: 2, conformance: "M", description: "Entry or extension was removed" })
  ),
  (0, import_elements.DatatypeElement)(
    {
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Pase", id: 1, conformance: "M", description: "Passcode authenticated session" }),
    (0, import_elements.FieldElement)({ name: "Case", id: 2, conformance: "M", description: "Certificate authenticated session" }),
    (0, import_elements.FieldElement)({ name: "Group", id: 3, conformance: "M", description: "Group authenticated session" })
  ),
  (0, import_elements.DatatypeElement)(
