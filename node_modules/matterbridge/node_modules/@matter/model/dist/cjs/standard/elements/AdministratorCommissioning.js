...
var AdministratorCommissioning_exports = {};
__export(AdministratorCommissioning_exports, {
  AdministratorCommissioning: () => AdministratorCommissioning
});
module.exports = __toCommonJS(AdministratorCommissioning_exports);
...
const AdministratorCommissioning = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "BC", constraint: "0", description: "Basic", details: "Node supports Basic Commissioning Method." })
  ),
  (0, import_elements.AttributeElement)({
    name: "WindowStatus",
    id: 0,
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "WindowNotOpen", id: 0, conformance: "M", description: "Commissioning window not open" }),
    (0, import_elements.FieldElement)({
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "WindowNotOpen", id: 4, conformance: "M", description: "No commissioning window was currently open" })
  )
);
