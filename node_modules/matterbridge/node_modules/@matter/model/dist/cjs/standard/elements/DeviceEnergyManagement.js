...
var DeviceEnergyManagement_exports = {};
__export(DeviceEnergyManagement_exports, {
  DeviceEnergyManagement: () => DeviceEnergyManagement
});
module.exports = __toCommonJS(DeviceEnergyManagement_exports);
...
const DeviceEnergyManagement = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Evse", id: 0, conformance: "O", description: "EV Supply Equipment" }),
    (0, import_elements.FieldElement)({ name: "SpaceHeating", id: 1, conformance: "O", description: "Space heating appliance" }),
    (0, import_elements.FieldElement)({ name: "WaterHeating", id: 2, conformance: "O", description: "Water heating appliance" }),
    (0, import_elements.FieldElement)({ name: "SpaceCooling", id: 3, conformance: "O", description: "Space cooling appliance" }),
    (0, import_elements.FieldElement)({ name: "SpaceHeatingCooling", id: 4, conformance: "O", description: "Space heating and cooling appliance" }),
    (0, import_elements.FieldElement)({ name: "BatteryStorage", id: 5, conformance: "O", description: "Battery Electric Storage System" }),
    (0, import_elements.FieldElement)({ name: "SolarPv", id: 6, conformance: "O", description: "Solar PV inverter" }),
    (0, import_elements.FieldElement)({ name: "FridgeFreezer", id: 7, conformance: "O", description: "Fridge / Freezer" }),
    (0, import_elements.FieldElement)({ name: "WashingMachine", id: 8, conformance: "O", description: "Washing Machine" }),
    (0, import_elements.FieldElement)({ name: "Dishwasher", id: 9, conformance: "O", description: "Dishwasher" }),
    (0, import_elements.FieldElement)({ name: "Cooking", id: 10, conformance: "O", description: "Cooking appliance" }),
    (0, import_elements.FieldElement)({ name: "HomeWaterPump", id: 11, conformance: "O", description: "Home water pump (e.g. drinking well)" }),
    (0, import_elements.FieldElement)({ name: "IrrigationWaterPump", id: 12, conformance: "O", description: "Irrigation water pump" }),
    (0, import_elements.FieldElement)({ name: "PoolPump", id: 13, conformance: "O", description: "Pool pump" }),
    (0, import_elements.FieldElement)({ name: "Other", id: 255, conformance: "O", description: "Other appliance type" })
  ),
  (0, import_elements.DatatypeElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Offline", id: 1, conformance: "M", description: "The ESA was set to offline" }),
    (0, import_elements.FieldElement)({
      name: "Fault",
      id: 2,
      conformance: "M",
    ...
    (0, import_elements.FieldElement)({ name: "Cancelled", id: 4, conformance: "M", description: "The adjustment was cancelled by a client" })
  ),
  (0, import_elements.DatatypeElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "GridOptimization", id: 2, conformance: "M", description: "The update was due to grid optimization" })
  ),
  (0, import_elements.DatatypeElement)(
    { name: "PowerAdjustReasonEnum", type: "enum8", xref: { document: "cluster", section: "9.2.7.8" } },
    (0, import_elements.FieldElement)({ name: "NoAdjustment", id: 0, conformance: "M", description: "There is no Power Adjustment active" }),
    (0, import_elements.FieldElement)({
