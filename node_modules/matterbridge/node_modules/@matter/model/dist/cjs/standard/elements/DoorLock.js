...
var DoorLock_exports = {};
__export(DoorLock_exports, {
  DoorLock: () => DoorLock
});
module.exports = __toCommonJS(DoorLock_exports);
...
const DoorLock = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Sunday", constraint: "0", description: "Schedule is applied on Sunday" }),
    (0, import_elements.FieldElement)({ name: "Monday", constraint: "1", description: "Schedule is applied on Monday" }),
    (0, import_elements.FieldElement)({ name: "Tuesday", constraint: "2", description: "Schedule is applied on Tuesday" }),
    (0, import_elements.FieldElement)({ name: "Wednesday", constraint: "3", description: "Schedule is applied on Wednesday" }),
    (0, import_elements.FieldElement)({ name: "Thursday", constraint: "4", description: "Schedule is applied on Thursday" }),
    (0, import_elements.FieldElement)({ name: "Friday", constraint: "5", description: "Schedule is applied on Friday" }),
    (0, import_elements.FieldElement)({ name: "Saturday", constraint: "6", description: "Schedule is applied on Saturday" })
  ),
  (0, import_elements.DatatypeElement)(
    { name: "CredentialRulesBitmap", type: "map8", xref: { document: "cluster", section: "5.2.6.2" } },
    (0, import_elements.FieldElement)({ name: "Single", constraint: "0", description: "Only one credential is required for lock operation" }),
    (0, import_elements.FieldElement)({ name: "Dual", constraint: "1", description: "Any two credentials are required for lock operation" }),
    (0, import_elements.FieldElement)({ name: "Tri", constraint: "2", description: "Any three credentials are required for lock operation" })
  ),
  (0, import_elements.DatatypeElement)(
    {
    ...
    (0, import_elements.FieldElement)({ name: "Normal", constraint: "0", description: "Normal operation mode is NOT supported" }),
    (0, import_elements.FieldElement)({ name: "Vacation", constraint: "1", description: "Vacation operation mode is NOT supported" }),
    (0, import_elements.FieldElement)({ name: "Privacy", constraint: "2", description: "Privacy operation mode is NOT supported" }),
    (0, import_elements.FieldElement)({
      name: "NoRemoteLockUnlock",
      constraint: "3",
      description: "No remote lock and unlock operation mode is NOT supported"
    }),
    (0, import_elements.FieldElement)({ name: "Passage", constraint: "4", description: "Passage operation mode is NOT supported" }),
    (0, import_elements.FieldElement)({
      name: "AlwaysSet",
      conformance: "M",
      constraint: "5 to 15",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "LockRadioPowerCycled", id: 3, conformance: "O", description: "Lock Radio Power Cycled" }),
    (0, import_elements.FieldElement)({
      name: "WrongCodeEntryLimit",
      id: 4,
      conformance: "[USR]",
    ...
    (0, import_elements.FieldElement)({ name: "DoorAjar", id: 7, conformance: "[DPS]", description: "Door ajar" }),
    (0, import_elements.FieldElement)({ name: "ForcedUser", id: 8, conformance: "[USR]", description: "Force User SOS alarm" })
  ),
  (0, import_elements.DatatypeElement)(
    {
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Modify", id: 2, conformance: "M", description: "Data is being modified or was modified" })
  ),
  (0, import_elements.DatatypeElement)(
    {
      name: "DoorStateEnum",
    ...
    (0, import_elements.FieldElement)({ name: "DoorJammed", id: 2, conformance: "[DPS]", description: "Door state is jammed" }),
    (0, import_elements.FieldElement)({ name: "DoorForcedOpen", id: 3, conformance: "[DPS]", description: "Door state is currently forced open" }),
    (0, import_elements.FieldElement)({
    ...
    (0, import_elements.FieldElement)({ name: "DoorAjar", id: 5, conformance: "[DPS]", description: "Door state is ajar" })
  ),
  (0, import_elements.DatatypeElement)(
    {
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Unlatch", id: 4, conformance: "M", description: "Unlatch operation" })
  ),
  (0, import_elements.DatatypeElement)(
    {
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Keypad", id: 3, conformance: "O", description: "Lock/unlock operation came from keypad" }),
    (0, import_elements.FieldElement)({
      name: "Auto",
      id: 4,
      conformance: "O",
    ...
    (0, import_elements.FieldElement)({ name: "Remote", id: 7, conformance: "M", description: "Lock/unlock operation came from remote node" }),
    (0, import_elements.FieldElement)({ name: "Rfid", id: 8, conformance: "RID", description: "Lock/unlock operation came from RFID card" }),
    (0, import_elements.FieldElement)({
      name: "Biometric",
      id: 9,
      conformance: "[USR]",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "OccupiedDisabled", id: 3, conformance: "O", description: "The user ID is occupied and disabled" })
  ),
  (0, import_elements.DatatypeElement)(
    {
      name: "UserTypeEnum",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Mortise", id: 3, conformance: "M", description: "Physical lock type is mortise" }),
    (0, import_elements.FieldElement)({ name: "Rim", id: 4, conformance: "M", description: "Physical lock type is rim" }),
    (0, import_elements.FieldElement)({ name: "LatchBolt", id: 5, conformance: "M", description: "Physical lock type is latch bolt" }),
    (0, import_elements.FieldElement)({ name: "CylindricalLock", id: 6, conformance: "M", description: "Physical lock type is cylindrical lock" }),
    (0, import_elements.FieldElement)({ name: "TubularLock", id: 7, conformance: "M", description: "Physical lock type is tubular lock" }),
    (0, import_elements.FieldElement)({
    ...
    (0, import_elements.FieldElement)({ name: "DeadLatch", id: 9, conformance: "M", description: "Physical lock type is dead latch" }),
    (0, import_elements.FieldElement)({ name: "DoorFurniture", id: 10, conformance: "M", description: "Physical lock type is door furniture" }),
