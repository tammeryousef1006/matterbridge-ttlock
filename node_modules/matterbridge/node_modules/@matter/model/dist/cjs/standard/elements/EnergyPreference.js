...
var EnergyPreference_exports = {};
__export(EnergyPreference_exports, {
  EnergyPreference: () => EnergyPreference
});
module.exports = __toCommonJS(EnergyPreference_exports);
...
const EnergyPreference = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    { name: "FeatureMap", id: 65532, type: "FeatureMap", xref: { document: "cluster", section: "9.7.4" } },
  ...
  (0, import_elements.AttributeElement)(
    {
      ...
      constraint: "2 to 10",
      quality: "F",
      details: "Indicates a list of BalanceStructs, each representing a condition or set of conditions for the device to enter a low power mode. This shall contain at least two BalanceStructs.\nEach BalanceStruct shall have a Step field larger than the Step field on the previous BalanceStruct in the list.",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "WaterConsumption", id: 3, conformance: "M", description: "Amount of water consumed by the device" })
  ),
  (0, import_elements.DatatypeElement)(
    {
      name: "BalanceStruct",
...
//# sourceMappingURL=EnergyPreference.js.map
