...
var MediaPlayback_exports = {};
__export(MediaPlayback_exports, {
  MediaPlayback: () => MediaPlayback
});
module.exports = __toCommonJS(MediaPlayback_exports);
...
const MediaPlayback = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    { name: "FeatureMap", id: 65532, type: "FeatureMap", xref: { document: "cluster", section: "6.10.4" } },
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Playing", id: 0, conformance: "M", description: "Media is currently playing (includes FF and REW)" }),
    (0, import_elements.FieldElement)({ name: "Paused", id: 1, conformance: "M", description: "Media is currently paused" }),
    (0, import_elements.FieldElement)({ name: "NotPlaying", id: 2, conformance: "M", description: "Media is not currently playing" }),
    (0, import_elements.FieldElement)({
      name: "Buffering",
      id: 3,
      conformance: "M",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Success", id: 0, conformance: "M", description: "Succeeded" }),
    (0, import_elements.FieldElement)({
    ...
    (0, import_elements.FieldElement)({ name: "NotActive", id: 3, conformance: "M", description: "This endpoint is not active for playback." }),
    (0, import_elements.FieldElement)({
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Subtitle", id: 8, conformance: "M", description: "Textual transcriptions of spoken dialog." }),
    (0, import_elements.FieldElement)({
      name: "Alternate",
      id: 9,
      conformance: "M",
