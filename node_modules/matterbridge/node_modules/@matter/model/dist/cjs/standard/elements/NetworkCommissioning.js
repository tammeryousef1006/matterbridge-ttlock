...
var NetworkCommissioning_exports = {};
__export(NetworkCommissioning_exports, {
  NetworkCommissioning: () => NetworkCommissioning
});
module.exports = __toCommonJS(NetworkCommissioning_exports);
...
const NetworkCommissioning = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Unencrypted", constraint: "0", description: "Supports unencrypted Wi-Fi" }),
    (0, import_elements.FieldElement)({ name: "Wep", constraint: "1", description: "Supports Wi-Fi using WEP security" }),
    (0, import_elements.FieldElement)({ name: "WpaPersonal", constraint: "2", description: "Supports Wi-Fi using WPA-Personal security" }),
    (0, import_elements.FieldElement)({ name: "Wpa2Personal", constraint: "3", description: "Supports Wi-Fi using WPA2-Personal security" }),
    (0, import_elements.FieldElement)({ name: "Wpa3Personal", constraint: "4", description: "Supports Wi-Fi using WPA3-Personal security" })
  ),
  (0, import_elements.DatatypeElement)(
    {
    ...
    (0, import_elements.FieldElement)({ name: "IsSleepyEndDeviceCapable", constraint: "2", description: "Sleepy end-device mode is supported" }),
    (0, import_elements.FieldElement)({
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "2G4", id: 0, conformance: "O.b+", description: "2.4GHz - 2.401GHz to2.495GHz(802.11b/g/n/ax)" }),
    (0, import_elements.FieldElement)({ name: "3G65", id: 1, conformance: "O.b+", description: "3.65GHz - 3.655GHz to3.695GHz (802.11y)" }),
    (0, import_elements.FieldElement)({ name: "5G", id: 2, conformance: "O.b+", description: "5GHz - 5.150GHz to5.895GHz(802.11a/n/ac/ax)" }),
    (0, import_elements.FieldElement)({ name: "6G", id: 3, conformance: "O.b+", description: "6GHz - 5.925GHz to7.125GHz (802.11ax / Wi-Fi 6E)" }),
    (0, import_elements.FieldElement)({ name: "60G", id: 4, conformance: "O.b+", description: "60GHz - 57.24GHz to70.20GHz (802.11ad/ay)" }),
    (0, import_elements.FieldElement)({ name: "1G", id: 5, conformance: "O.b+", description: "Sub-1GHz - 755MHz to 931MHz (802.11ah)" })
  ),
  (0, import_elements.DatatypeElement)(
    { name: "NetworkCommissioningStatusEnum", type: "enum8", xref: { document: "core", section: "11.9.5.4" } },
    (0, import_elements.FieldElement)({ name: "Success", id: 0, conformance: "M", description: "OK, no error" }),
    (0, import_elements.FieldElement)({ name: "OutOfRange", id: 1, conformance: "M", description: "Value Outside Range" }),
    (0, import_elements.FieldElement)({ name: "BoundsExceeded", id: 2, conformance: "M", description: "A collection would exceed its size limit" }),
    (0, import_elements.FieldElement)({
    ...
    (0, import_elements.FieldElement)({ name: "NetworkNotFound", id: 5, conformance: "M", description: "Cannot find AP: SSID Not found" }),
    (0, import_elements.FieldElement)({
    ...
    (0, import_elements.FieldElement)({ name: "OtherConnectionFailure", id: 9, conformance: "M", description: "Other association failure" }),
    (0, import_elements.FieldElement)({ name: "Ipv6Failed", id: 10, conformance: "M", description: "Failure to generate an IPv6 address" }),
    (0, import_elements.FieldElement)({ name: "IpBindFailed", id: 11, conformance: "M", description: "Failure to bind Wi-Fi <-> IP interfaces" }),
    (0, import_elements.FieldElement)({ name: "UnknownError", id: 12, conformance: "M", description: "Unknown error" })
  ),
  (0, import_elements.DatatypeElement)(
    {
