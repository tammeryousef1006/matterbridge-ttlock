...
var OperationalCredentials_exports = {};
__export(OperationalCredentials_exports, {
  OperationalCredentials: () => OperationalCredentials
});
module.exports = __toCommonJS(OperationalCredentials_exports);
...
const OperationalCredentials = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "DacCertificate", id: 1, conformance: "M", description: "Request the DER- encoded DAC certificate" }),
    (0, import_elements.FieldElement)({ name: "PaiCertificate", id: 2, conformance: "M", description: "Request the DER- encoded PAI certificate" })
  ),
  (0, import_elements.DatatypeElement)(
    {
    ...
    (0, import_elements.FieldElement)({ name: "Ok", id: 0, conformance: "M", description: "OK, no error" }),
    (0, import_elements.FieldElement)({
    ...
    (0, import_elements.FieldElement)({ name: "InvalidNoc", id: 3, conformance: "M", description: "Any other validation error in NOC chain" }),
    (0, import_elements.FieldElement)({
      name: "MissingCsr",
      id: 4,
      conformance: "M",
    ...
    (0, import_elements.FieldElement)({ name: "TableFull", id: 5, conformance: "M", description: "NOCs table full, cannot add another one" }),
    (0, import_elements.FieldElement)({
    ...
    (0, import_elements.FieldElement)({ name: "LabelConflict", id: 10, conformance: "M", description: "Label already exists on another Fabric." }),
    (0, import_elements.FieldElement)({ name: "InvalidFabricIndex", id: 11, conformance: "M", description: "FabricIndex argument is invalid." })
  ),
  (0, import_elements.DatatypeElement)(
    {
      name: "NOCStruct",
