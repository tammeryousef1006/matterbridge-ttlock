...
var OtaSoftwareUpdateProvider_exports = {};
__export(OtaSoftwareUpdateProvider_exports, {
  OtaSoftwareUpdateProvider: () => OtaSoftwareUpdateProvider
});
module.exports = __toCommonJS(OtaSoftwareUpdateProvider_exports);
...
See Section 11.20.3.2, \u201CQuerying the OTA Provider\u201D for additional details about the flow.`,
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Proceed", id: 0, conformance: "M", description: "Apply the update." }),
    (0, import_elements.FieldElement)({ name: "AwaitNextAction", id: 1, conformance: "M", description: "Wait at least the given delay time." }),
    (0, import_elements.FieldElement)({
      name: "Discontinue",
      id: 2,
      conformance: "M",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "BdxSynchronous", id: 0, conformance: "M", description: "Indicates support for synchronous BDX." }),
    (0, import_elements.FieldElement)({ name: "BdxAsynchronous", id: 1, conformance: "O", description: "Indicates support for asynchronous BDX." }),
    (0, import_elements.FieldElement)({ name: "Https", id: 2, conformance: "O", description: "Indicates support for HTTPS." }),
    (0, import_elements.FieldElement)({
      name: "VendorSpecific",
      id: 3,
      conformance: "O",
