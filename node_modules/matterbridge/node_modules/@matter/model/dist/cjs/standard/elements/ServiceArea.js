...
var ServiceArea_exports = {};
__export(ServiceArea_exports, {
  ServiceArea: () => ServiceArea
});
module.exports = __toCommonJS(ServiceArea_exports);
...
const ServiceArea = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "MAPS", constraint: "2", description: "Maps", details: "The device has map support" })
  ),
  (0, import_elements.AttributeElement)(
    {
      name: "SupportedAreas",
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "InvalidAreaList", id: 1, conformance: "M", description: "The SelectedAreas attribute is empty." }),
    (0, import_elements.FieldElement)({
      name: "InvalidInMode",
      id: 2,
      conformance: "M",
