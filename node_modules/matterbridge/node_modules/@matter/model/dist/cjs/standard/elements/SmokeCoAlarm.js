...
var SmokeCoAlarm_exports = {};
__export(SmokeCoAlarm_exports, {
  SmokeCoAlarm: () => SmokeCoAlarm
});
module.exports = __toCommonJS(SmokeCoAlarm_exports);
...
const SmokeCoAlarm = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    { name: "FeatureMap", id: 65532, type: "FeatureMap", xref: { document: "cluster", section: "2.11.4" } },
    ...
    (0, import_elements.FieldElement)({ name: "CO", conformance: "O.a+", constraint: "1", description: "CoAlarm", details: "Supports CO alarm" })
  ),
  (0, import_elements.AttributeElement)({
    name: "ExpressedState",
    id: 0,
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "High", id: 0, conformance: "O", description: "High sensitivity" }),
    (0, import_elements.FieldElement)({ name: "Standard", id: 1, conformance: "M", description: "Standard Sensitivity" }),
...
//# sourceMappingURL=SmokeCoAlarm.js.map
