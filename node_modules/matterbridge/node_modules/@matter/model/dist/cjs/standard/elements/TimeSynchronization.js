...
var TimeSynchronization_exports = {};
__export(TimeSynchronization_exports, {
  TimeSynchronization: () => TimeSynchronization
});
module.exports = __toCommonJS(TimeSynchronization_exports);
...
const TimeSynchronization = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    { name: "FeatureMap", id: 65532, type: "FeatureMap", xref: { document: "core", section: "11.17.5" } },
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "Unknown", id: 1, conformance: "M", description: "Node uses an unlisted time source." }),
    (0, import_elements.FieldElement)({
      name: "Admin",
      id: 2,
      conformance: "M",
    ...
    (0, import_elements.FieldElement)({ name: "Ptp", id: 15, conformance: "M", description: "Time synchronization comes from PTP." }),
    (0, import_elements.FieldElement)({ name: "Gnss", id: 16, conformance: "M", description: "Time synchronization comes from a GNSS source." })
  ),
  (0, import_elements.DatatypeElement)(
    {
    ...
    (0, import_elements.FieldElement)({ name: "Full", id: 0, conformance: "M", description: "Node has a full list of the available time zones" }),
    (0, import_elements.FieldElement)({
      name: "Partial",
      id: 1,
      conformance: "M",
    ...
    (0, import_elements.FieldElement)({ name: "None", id: 2, conformance: "M", description: "Node does not have a time zone database" })
  ),
  (0, import_elements.DatatypeElement)(
...
//# sourceMappingURL=TimeSynchronization.js.map
