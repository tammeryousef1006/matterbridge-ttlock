...
var ValveConfigurationAndControl_exports = {};
__export(ValveConfigurationAndControl_exports, {
  ValveConfigurationAndControl: () => ValveConfigurationAndControl
});
module.exports = __toCommonJS(ValveConfigurationAndControl_exports);
...
const ValveConfigurationAndControl = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "GeneralFault", constraint: "0", description: "Unspecified fault detected" }),
    (0, import_elements.FieldElement)({ name: "Blocked", constraint: "1", description: "Valve is blocked" }),
    (0, import_elements.FieldElement)({ name: "Leaking", constraint: "2", description: "Valve has detected a leak" }),
    (0, import_elements.FieldElement)({ name: "NotConnected", constraint: "3", description: "No valve is connected to controller" }),
    (0, import_elements.FieldElement)({ name: "ShortCircuit", constraint: "4", description: "Short circuit is detected" }),
    (0, import_elements.FieldElement)({ name: "CurrentExceeded", constraint: "5", description: "The available current has been exceeded" })
  ),
  (0, import_elements.DatatypeElement)(
    { name: "ValveStateEnum", type: "enum8", xref: { document: "cluster", section: "4.6.5.2" } },
    (0, import_elements.FieldElement)({ name: "Closed", id: 0, conformance: "M", description: "Valve is in closed position" }),
    (0, import_elements.FieldElement)({ name: "Open", id: 1, conformance: "M", description: "Valve is in open position" }),
    (0, import_elements.FieldElement)({
      name: "Transitioning",
      id: 2,
      conformance: "M",
