...
var WaterHeaterManagement_exports = {};
__export(WaterHeaterManagement_exports, {
  WaterHeaterManagement: () => WaterHeaterManagement
});
module.exports = __toCommonJS(WaterHeaterManagement_exports);
...
const WaterHeaterManagement = (0, import_elements.ClusterElement)(
  ...
  (0, import_elements.AttributeElement)(
    { name: "FeatureMap", id: 65532, type: "FeatureMap", xref: { document: "cluster", section: "9.5.4" } },
  ...
  (0, import_elements.DatatypeElement)(
    ...
    (0, import_elements.FieldElement)({ name: "ImmersionElement1", constraint: "0", description: "Immersion Heating Element 1" }),
    (0, import_elements.FieldElement)({ name: "ImmersionElement2", constraint: "1", description: "Immersion Heating Element 2" }),
    (0, import_elements.FieldElement)({ name: "HeatPump", constraint: "2", description: "Heat pump Heating" }),
    (0, import_elements.FieldElement)({ name: "Boiler", constraint: "3", description: "Boiler Heating (e.g. Gas or Oil)" }),
    (0, import_elements.FieldElement)({ name: "Other", constraint: "4", description: "Other Heating" })
  ),
  (0, import_elements.DatatypeElement)(
    { name: "BoostStateEnum", type: "enum8", xref: { document: "cluster", section: "9.5.6.2" } },
    (0, import_elements.FieldElement)({ name: "Inactive", id: 0, conformance: "M", description: "Boost is not currently active" }),
    (0, import_elements.FieldElement)({ name: "Active", id: 1, conformance: "M", description: "Boost is currently active" })
  ),
  (0, import_elements.DatatypeElement)(
...
//# sourceMappingURL=WaterHeaterManagement.js.map
