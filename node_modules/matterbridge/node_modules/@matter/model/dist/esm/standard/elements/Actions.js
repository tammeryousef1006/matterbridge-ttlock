...
const Actions = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Inactive", id: 0, conformance: "M", description: "The action is not active" }),
    Field({ name: "Active", id: 1, conformance: "M", description: "The action is active" }),
    Field({ name: "Paused", id: 2, conformance: "M", description: "The action has been paused" }),
    Field({ name: "Disabled", id: 3, conformance: "M", description: "The action has been disabled" })
  ),
  Datatype(
    { name: "ActionErrorEnum", type: "enum8", xref: { document: "core", section: "9.14.4.4" } },
    Field({ name: "Unknown", id: 0, conformance: "M", description: "Other reason not listed in the row(s) below" }),
    Field({
      name: "Interrupted",
      id: 1,
      conformance: "M",
