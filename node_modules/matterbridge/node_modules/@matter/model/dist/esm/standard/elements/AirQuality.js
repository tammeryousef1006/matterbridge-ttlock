...
const AirQuality = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Unknown", id: 0, conformance: "M", description: "The air quality is unknown." }),
    Field({ name: "Good", id: 1, conformance: "M", description: "The air quality is good." }),
    Field({ name: "Fair", id: 2, conformance: "FAIR", description: "The air quality is fair." }),
    Field({ name: "Moderate", id: 3, conformance: "MOD", description: "The air quality is moderate." }),
    Field({ name: "Poor", id: 4, conformance: "M", description: "The air quality is poor." }),
    Field({ name: "VeryPoor", id: 5, conformance: "VPOOR", description: "The air quality is very poor." }),
    Field({ name: "ExtremelyPoor", id: 6, conformance: "XPOOR", description: "The air quality is extremely poor." })
  )
);
