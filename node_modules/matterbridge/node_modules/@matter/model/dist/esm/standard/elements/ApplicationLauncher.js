...
const ApplicationLauncher = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "AppNotAvailable", id: 1, conformance: "M", description: "Requested app is not available" }),
    Field({ name: "SystemBusy", id: 2, conformance: "M", description: "Video platform unable to honor command" }),
    Field({
    ...
    Field({ name: "Downloading", id: 4, conformance: "M", description: "Downloading the requested app" }),
    Field({ name: "Installing", id: 5, conformance: "M", description: "Installing the requested app" })
  ),
  Datatype(
    {
