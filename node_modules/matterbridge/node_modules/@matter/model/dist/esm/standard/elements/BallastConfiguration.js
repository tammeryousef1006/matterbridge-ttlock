...
const BallastConfiguration = Cluster(
  {
  ...
  Attribute({ name: "PowerOnLevel", id: 18, conformance: "D", xref: { document: "cluster", section: "3.3.6" } }),
  Attribute({ name: "PowerOnFadeTime", id: 19, conformance: "D", xref: { document: "cluster", section: "3.3.6" } }),
  Attribute({
