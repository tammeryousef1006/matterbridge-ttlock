...
const BasicInformation = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Other", id: 0, conformance: "M", description: "Product has some other finish not listed below." }),
    Field({ name: "Matte", id: 1, conformance: "M", description: "Product has a matte finish." }),
    Field({ name: "Satin", id: 2, conformance: "M", description: "Product has a satin finish." }),
    Field({ name: "Polished", id: 3, conformance: "M", description: "Product has a polished or shiny finish." }),
    Field({ name: "Rugged", id: 4, conformance: "M", description: "Product has a rugged finish." }),
    Field({ name: "Fabric", id: 5, conformance: "M", description: "Product has a fabric finish." })
  ),
  Datatype(
    {
      name: "ColorEnum",
    ...
    Field({ name: "Black", id: 0, conformance: "M", description: "Approximately RGB #000000." }),
    Field({ name: "Navy", id: 1, conformance: "M", description: "Approximately RGB #000080." }),
    Field({ name: "Green", id: 2, conformance: "M", description: "Approximately RGB #008000." }),
    Field({ name: "Teal", id: 3, conformance: "M", description: "Approximately RGB #008080." }),
    Field({ name: "Maroon", id: 4, conformance: "M", description: "Approximately RGB #800080." }),
    Field({ name: "Purple", id: 5, conformance: "M", description: "Approximately RGB #800080." }),
    Field({ name: "Olive", id: 6, conformance: "M", description: "Approximately RGB #808000." }),
    Field({ name: "Gray", id: 7, conformance: "M", description: "Approximately RGB #808080." }),
    Field({ name: "Blue", id: 8, conformance: "M", description: "Approximately RGB #0000FF." }),
    Field({ name: "Lime", id: 9, conformance: "M", description: "Approximately RGB #00FF00." }),
    Field({ name: "Aqua", id: 10, conformance: "M", description: "Approximately RGB #00FFFF." }),
    Field({ name: "Red", id: 11, conformance: "M", description: "Approximately RGB #FF0000." }),
    Field({ name: "Fuchsia", id: 12, conformance: "M", description: "Approximately RGB #FF00FF." }),
    Field({ name: "Yellow", id: 13, conformance: "M", description: "Approximately RGB #FFFF00." }),
    Field({ name: "White", id: 14, conformance: "M", description: "Approximately RGB #FFFFFF." }),
    Field({ name: "Nickel", id: 15, conformance: "M", description: 'Typical hardware "Nickel" color.' }),
    Field({ name: "Chrome", id: 16, conformance: "M", description: 'Typical hardware "Chrome" color.' }),
    Field({ name: "Brass", id: 17, conformance: "M", description: 'Typical hardware "Brass" color.' }),
    Field({ name: "Copper", id: 18, conformance: "M", description: 'Typical hardware "Copper" color.' }),
    Field({ name: "Silver", id: 19, conformance: "M", description: 'Typical hardware "Silver" color.' }),
    Field({ name: "Gold", id: 20, conformance: "M", description: 'Typical hardware "Gold" color.' })
  ),
  Datatype(
    {
