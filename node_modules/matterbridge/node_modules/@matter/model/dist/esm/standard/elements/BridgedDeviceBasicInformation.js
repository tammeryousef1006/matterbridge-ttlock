...
const BridgedDeviceBasicInformation = Cluster(
  ...
  Attribute({ name: "DataModelRevision", id: 0, conformance: "X", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "VendorName", id: 1, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "VendorId", id: 2, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "ProductName", id: 3, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "ProductId", id: 4, conformance: "desc", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "NodeLabel", id: 5, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "Location", id: 6, conformance: "X", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "HardwareVersion", id: 7, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "HardwareVersionString", id: 8, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "SoftwareVersion", id: 9, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "SoftwareVersionString", id: 10, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "ManufacturingDate", id: 11, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "PartNumber", id: 12, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "ProductUrl", id: 13, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "ProductLabel", id: 14, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "SerialNumber", id: 15, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "LocalConfigDisabled", id: 16, conformance: "X", xref: { document: "core", section: "9.13.5" } }),
  Attribute({
    name: "Reachable",
    id: 17,
    conformance: "M",
  ...
  Attribute({ name: "CapabilityMinima", id: 19, conformance: "X", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "ProductAppearance", id: 20, conformance: "O", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "SpecificationVersion", id: 21, conformance: "X", xref: { document: "core", section: "9.13.5" } }),
  Attribute({ name: "MaxPathsPerInvoke", id: 22, conformance: "X", xref: { document: "core", section: "9.13.5" } }),
  Event({ name: "StartUp", id: 0, conformance: "O", priority: "critical", xref: { document: "core", section: "9.13.7" } }),
  Event({
    name: "ShutDown",
    id: 1,
    conformance: "O",
