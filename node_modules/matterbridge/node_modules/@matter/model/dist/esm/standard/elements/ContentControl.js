...
const ContentControl = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "InvalidPinCode", id: 2, description: "Provided PIN Code does not match the current PIN code." }),
    Field({
      name: "InvalidRating",
      id: 3,
      description: "Provided Rating is out of scope of the corresponding Rating list."
    }),
    Field({ name: "InvalidChannel", id: 4, description: "Provided Channel(s) is invalid." }),
    Field({ name: "ChannelAlreadyExist", id: 5, description: "Provided Channel(s) already exists." }),
    Field({
      name: "ChannelNotExist",
      id: 6,
      description: "Provided Channel(s) doesn\u2019t exist in BlockChannelList attribute."
    }),
    Field({ name: "UnidentifiableApplication", id: 7, description: "Provided Application(s) is not identified." }),
    Field({ name: "ApplicationAlreadyExist", id: 8, description: "Provided Application(s) already exists." }),
    Field({
