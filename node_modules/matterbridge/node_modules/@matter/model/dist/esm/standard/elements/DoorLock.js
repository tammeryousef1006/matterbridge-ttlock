...
const DoorLock = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "LockRadioPowerCycled", id: 3, conformance: "O", description: "Lock Radio Power Cycled" }),
    Field({
      name: "WrongCodeEntryLimit",
      id: 4,
      conformance: "[USR]",
    ...
    Field({ name: "DoorAjar", id: 7, conformance: "[DPS]", description: "Door ajar" }),
    Field({ name: "ForcedUser", id: 8, conformance: "[USR]", description: "Force User SOS alarm" })
  ),
  Datatype(
    {
  ...
  Datatype(
    ...
    Field({ name: "Modify", id: 2, conformance: "M", description: "Data is being modified or was modified" })
  ),
  Datatype(
    {
      name: "DoorStateEnum",
    ...
    Field({ name: "DoorJammed", id: 2, conformance: "[DPS]", description: "Door state is jammed" }),
    Field({ name: "DoorForcedOpen", id: 3, conformance: "[DPS]", description: "Door state is currently forced open" }),
    Field({
    ...
    Field({ name: "DoorAjar", id: 5, conformance: "[DPS]", description: "Door state is ajar" })
  ),
  Datatype(
    {
  ...
  Datatype(
    ...
    Field({ name: "Unlatch", id: 4, conformance: "M", description: "Unlatch operation" })
  ),
  Datatype(
    {
  ...
  Datatype(
    ...
    Field({ name: "Keypad", id: 3, conformance: "O", description: "Lock/unlock operation came from keypad" }),
    Field({
      name: "Auto",
      id: 4,
      conformance: "O",
    ...
    Field({ name: "Remote", id: 7, conformance: "M", description: "Lock/unlock operation came from remote node" }),
    Field({ name: "Rfid", id: 8, conformance: "RID", description: "Lock/unlock operation came from RFID card" }),
    Field({
      name: "Biometric",
      id: 9,
      conformance: "[USR]",
  ...
  Datatype(
    ...
    Field({ name: "OccupiedDisabled", id: 3, conformance: "O", description: "The user ID is occupied and disabled" })
  ),
  Datatype(
    {
      name: "UserTypeEnum",
  ...
  Datatype(
    ...
    Field({ name: "Mortise", id: 3, conformance: "M", description: "Physical lock type is mortise" }),
    Field({ name: "Rim", id: 4, conformance: "M", description: "Physical lock type is rim" }),
    Field({ name: "LatchBolt", id: 5, conformance: "M", description: "Physical lock type is latch bolt" }),
    Field({ name: "CylindricalLock", id: 6, conformance: "M", description: "Physical lock type is cylindrical lock" }),
    Field({ name: "TubularLock", id: 7, conformance: "M", description: "Physical lock type is tubular lock" }),
    Field({
    ...
    Field({ name: "DeadLatch", id: 9, conformance: "M", description: "Physical lock type is dead latch" }),
    Field({ name: "DoorFurniture", id: 10, conformance: "M", description: "Physical lock type is door furniture" }),
