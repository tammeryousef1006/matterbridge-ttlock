...
const EnergyEvse = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "NotPluggedIn", id: 0, conformance: "M", description: "The EV is not plugged in." }),
    Field({
    ...
    Field({ name: "Fault", id: 6, conformance: "M", description: "There is a fault (see FaultState attribute)" })
  ),
  Datatype(
    ...
    Field({ name: "ChargingEnabled", id: 1, conformance: "M", description: "The EV is currently allowed to charge" }),
    Field({
  ...
  Datatype(
    ...
    Field({ name: "NoError", id: 0, conformance: "M", description: "The EVSE is not in an error state." }),
    Field({
      name: "MeterFailure",
      id: 1,
      conformance: "M",
    ...
    Field({ name: "OverVoltage", id: 2, conformance: "M", description: "The EVSE input voltage level is too high." }),
    Field({ name: "UnderVoltage", id: 3, conformance: "M", description: "The EVSE input voltage level is too low." }),
    Field({
      name: "OverCurrent",
      id: 4,
      conformance: "M",
    ...
    Field({ name: "GroundFault", id: 7, conformance: "M", description: "The EVSE has an unbalanced current supply." }),
    Field({ name: "PowerLoss", id: 8, conformance: "M", description: "The EVSE has detected a loss in power." }),
    Field({
      name: "PowerQuality",
      id: 9,
      conformance: "M",
    ...
    Field({ name: "EmergencyStop", id: 11, conformance: "M", description: "The emergency stop button was pressed." }),
    Field({
      name: "EvDisconnected",
      id: 12,
      conformance: "M",
    ...
    Field({ name: "Other", id: 255, conformance: "M", description: "Any other reason." })
  ),
  Datatype(
    { name: "EnergyTransferStoppedReasonEnum", type: "enum8", xref: { document: "cluster", section: "9.3.7.5" } },
    Field({ name: "EvStopped", id: 0, conformance: "M", description: "The EV decided to stop" }),
    Field({ name: "EvseStopped", id: 1, conformance: "M", description: "The EVSE decided to stop" }),
    Field({ name: "Other", id: 2, conformance: "M", description: "An other unknown reason" })
  ),
  Datatype(
    {
