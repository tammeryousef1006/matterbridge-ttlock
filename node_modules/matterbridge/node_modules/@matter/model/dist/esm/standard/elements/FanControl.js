...
const FanControl = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Increase", id: 0, conformance: "M", description: "Step moves in increasing direction" }),
    Field({ name: "Decrease", id: 1, conformance: "M", description: "Step moves in decreasing direction" })
  ),
  Datatype(
    { name: "AirflowDirectionEnum", type: "enum8", xref: { document: "cluster", section: "4.4.5.4" } },
    Field({ name: "Forward", id: 0, conformance: "M", description: "Airflow is in the forward direction" }),
    Field({ name: "Reverse", id: 1, conformance: "M", description: "Airflow is in the reverse direction" })
  ),
  Datatype(
    { name: "FanModeEnum", type: "enum8", xref: { document: "cluster", section: "4.4.5.5" } },
    Field({ name: "Off", id: 0, conformance: "M", description: "Fan is off" }),
    Field({
      name: "Low",
      id: 1,
      conformance: "desc",
    ...
    Field({ name: "High", id: 3, conformance: "M", description: "Fan using high speed" }),
    Field({ name: "On", id: 4, conformance: "D" }),
    Field({ name: "Auto", id: 5, conformance: "AUT", description: "Fan is using auto mode" }),
    Field({ name: "Smart", id: 6, conformance: "D", description: "Fan is using smart mode" })
  ),
  Datatype(
    ...
    Field({ name: "OffHigh", id: 5, conformance: "[!AUT].a", description: "Fan is capable of off and high modes" })
  )
);
