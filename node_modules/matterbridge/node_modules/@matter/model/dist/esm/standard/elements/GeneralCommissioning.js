...
If the fail-safe timer expires before the CommissioningComplete command is successfully invoked, the following sequence of clean-up steps shall be executed, in order, by the receiver:
  ...
  Datatype(
    ...
    Field({ name: "Indoor", id: 0, conformance: "M", description: "Indoor only" }),
    Field({ name: "Outdoor", id: 1, conformance: "M", description: "Outdoor only" }),
    Field({ name: "IndoorOutdoor", id: 2, conformance: "M", description: "Indoor/Outdoor" })
  ),
  Datatype(
    {
      name: "BasicCommissioningInfo",
