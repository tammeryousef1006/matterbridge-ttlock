...
const GeneralDiagnostics = Cluster(
  ...
  Attribute({ name: "DoNotUse", id: 9, conformance: "X", xref: { document: "core", section: "11.12.6" } }),
  Event(
    {
  ...
  Datatype(
    ...
    Field({ name: "WiFi", id: 1, conformance: "O", description: "Indicates a Wi-Fi interface." }),
    Field({ name: "Ethernet", id: 2, conformance: "O", description: "Indicates a Ethernet interface." }),
    Field({ name: "Cellular", id: 3, conformance: "O", description: "Indicates a Cellular interface." }),
    Field({ name: "Thread", id: 4, conformance: "O", description: "Indicates a Thread interface." })
  ),
  Datatype(
