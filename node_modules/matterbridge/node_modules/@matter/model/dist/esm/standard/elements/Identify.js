...
const Identify = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "None", id: 0, conformance: "M", description: "No presentation." }),
    Field({ name: "LightOutput", id: 1, conformance: "M", description: "Light output of a lighting product." }),
    Field({ name: "VisibleIndicator", id: 2, conformance: "M", description: "Typically a small LED." }),
    Field({ name: "AudibleBeep", id: 3, conformance: "M" }),
    Field({ name: "Display", id: 4, conformance: "M", description: "Presentation will be visible on display screen." }),
    Field({
      name: "Actuator",
      id: 5,
      conformance: "M",
  ...
  Datatype(
    ...
    Field({ name: "Blink", id: 0, conformance: "M", description: "e.g., Light is turned on/off once." }),
    Field({
      name: "Breathe",
      id: 1,
      conformance: "M",
    ...
    Field({ name: "StopEffect", id: 255, conformance: "M", description: "Terminate the effect as soon as possible." })
  ),
  Datatype(
    { name: "EffectVariantEnum", type: "enum8", xref: { document: "cluster", section: "1.2.4.3" } },
    Field({ name: "Default", id: 0, conformance: "M", description: "Indicates the default effect is used" })
  )
);
