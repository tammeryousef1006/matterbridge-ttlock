...
const LaundryDryerControls = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Low", id: 0, conformance: "M", description: "Provides a low dryness level for the selected mode" }),
    Field({
      name: "Normal",
      id: 1,
      conformance: "M",
    ...
    Field({ name: "Max", id: 3, conformance: "M", description: "Provides the max dryness level for the selected mode" })
  )
);
...
//# sourceMappingURL=LaundryDryerControls.js.map
