...
const MediaPlayback = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Playing", id: 0, conformance: "M", description: "Media is currently playing (includes FF and REW)" }),
    Field({ name: "Paused", id: 1, conformance: "M", description: "Media is currently paused" }),
    Field({ name: "NotPlaying", id: 2, conformance: "M", description: "Media is not currently playing" }),
    Field({
      name: "Buffering",
      id: 3,
      conformance: "M",
  ...
  Datatype(
    ...
    Field({ name: "NotActive", id: 3, conformance: "M", description: "This endpoint is not active for playback." }),
    Field({
  ...
  Datatype(
    ...
    Field({ name: "Subtitle", id: 8, conformance: "M", description: "Textual transcriptions of spoken dialog." }),
    Field({
      name: "Alternate",
      id: 9,
      conformance: "M",
