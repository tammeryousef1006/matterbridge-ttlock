...
const Messages = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Allowed", id: 0, conformance: "M", description: "Similar messages are allowed" }),
    Field({ name: "Increased", id: 1, conformance: "M", description: "Similar messages should be sent more often" }),
    Field({ name: "Reduced", id: 2, conformance: "M", description: "Similar messages should be sent less often" }),
    Field({ name: "Disallowed", id: 3, conformance: "M", description: "Similar messages should not be sent" }),
    Field({ name: "Banned", id: 4, conformance: "M", description: "No further messages should be sent" })
  ),
  Datatype(
    {
