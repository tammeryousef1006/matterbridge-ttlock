...
const ModeBase = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Auto", id: 0, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "Quick", id: 1, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "Quiet", id: 2, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "LowNoise", id: 3, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "LowEnergy", id: 4, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "Vacation", id: 5, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "Min", id: 6, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "Max", id: 7, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "Night", id: 8, xref: { document: "cluster", section: "1.10.8" } }),
    Field({ name: "Day", id: 9, xref: { document: "cluster", section: "1.10.8" } })
  )
);
