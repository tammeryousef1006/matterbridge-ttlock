...
const OnOff = Cluster(
  ...
  Attribute(
    { name: "FeatureMap", id: 65532, type: "FeatureMap", xref: { document: "cluster", section: "1.5.4" } },
    Field({
      name: "LT",
      conformance: "[!OFFONLY]",
      constraint: "0",
  ...
  Datatype(
    ...
    Field({ name: "Off", id: 0, conformance: "M", description: "Set the OnOff attribute to FALSE" }),
    Field({ name: "On", id: 1, conformance: "M", description: "Set the OnOff attribute to TRUE" }),
    Field({
      name: "Toggle",
      id: 2,
      conformance: "M",
  ...
  Datatype(
    ...
    Field({ name: "DelayedAllOff", id: 0, conformance: "M", description: "Delayed All Off" }),
    Field({ name: "DyingLight", id: 1, conformance: "M", description: "Dying Light" })
  ),
  Datatype(
    { name: "DelayedAllOffEffectVariantEnum", type: "enum8", xref: { document: "cluster", section: "1.5.5.4" } },
    Field({ name: "DelayedOffFastFade", id: 0, conformance: "M", description: "Fade to off in 0.8 seconds" }),
    Field({ name: "NoFade", id: 1, conformance: "M", description: "No fade" }),
    Field({
