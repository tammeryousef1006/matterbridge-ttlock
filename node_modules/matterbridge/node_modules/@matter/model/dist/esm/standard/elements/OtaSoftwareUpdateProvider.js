...
See Section 11.20.3.2, \u201CQuerying the OTA Provider\u201D for additional details about the flow.`,
  ...
  Datatype(
    ...
    Field({ name: "Proceed", id: 0, conformance: "M", description: "Apply the update." }),
    Field({ name: "AwaitNextAction", id: 1, conformance: "M", description: "Wait at least the given delay time." }),
    Field({
      name: "Discontinue",
      id: 2,
      conformance: "M",
  ...
  Datatype(
    ...
    Field({ name: "BdxSynchronous", id: 0, conformance: "M", description: "Indicates support for synchronous BDX." }),
    Field({ name: "BdxAsynchronous", id: 1, conformance: "O", description: "Indicates support for asynchronous BDX." }),
    Field({ name: "Https", id: 2, conformance: "O", description: "Indicates support for HTTPS." }),
    Field({
      name: "VendorSpecific",
      id: 3,
      conformance: "O",
