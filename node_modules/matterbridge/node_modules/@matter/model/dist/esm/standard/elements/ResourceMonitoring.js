...
const ResourceMonitoring = Cluster(
  ...
  Attribute(
    { name: "FeatureMap", id: 65532, type: "FeatureMap", xref: { document: "cluster", section: "2.8.4" } },
    Field({
      name: "CON",
      conformance: "O",
      constraint: "0",
  ...
  Datatype(
    ...
    Field({ name: "Upc", id: 0, conformance: "M", description: "12-digit Universal Product Code" }),
    Field({ name: "Gtin8", id: 1, conformance: "M", description: "8-digit Global Trade Item Number" }),
    Field({ name: "Ean", id: 2, conformance: "M", description: "13-digit European Article Number" }),
    Field({ name: "Gtin14", id: 3, conformance: "M", description: "14-digit Global Trade Item Number" }),
    Field({ name: "Oem", id: 4, conformance: "M", description: "Original Equipment Manufacturer part number" })
  ),
  Datatype(
    {
...
//# sourceMappingURL=ResourceMonitoring.js.map
