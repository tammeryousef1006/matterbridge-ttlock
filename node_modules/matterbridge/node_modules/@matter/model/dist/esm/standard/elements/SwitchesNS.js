...
const SwitchesNs = SemanticNamespace(
  {
    name: "Switches",
    id: 67,
  ...
  SemanticTag({ name: "On", id: 0 }),
  SemanticTag({ name: "Off", id: 1 }),
  SemanticTag({ name: "Toggle", id: 2 }),
  SemanticTag({ name: "Up", id: 3, description: "e.g. dim up (light)" }),
  SemanticTag({ name: "Down", id: 4, description: "e.g. dim down (light)" }),
  SemanticTag({ name: "Next", id: 5, description: "e.g. select next scene" }),
  SemanticTag({ name: "Previous", id: 6, description: "e.g. select previous scene" }),
  SemanticTag({ name: "Enter/OK/Select", id: 7 }),
  SemanticTag({
    name: "Custom",
    id: 8,
