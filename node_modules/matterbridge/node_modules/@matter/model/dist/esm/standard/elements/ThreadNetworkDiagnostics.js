...
const ThreadNetworkDiagnostics = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Unspecified", id: 0, conformance: "M", description: "Indicates an unspecified fault." }),
    Field({ name: "LinkDown", id: 1, conformance: "M", description: "Indicates the Thread link is down." }),
    Field({
    ...
    Field({ name: "NetworkJammed", id: 3, conformance: "M", description: "Indicates the Thread network is jammed." })
  ),
  Datatype(
    { name: "ConnectionStatusEnum", type: "enum8", xref: { document: "core", section: "11.14.5.2" } },
    Field({ name: "Connected", id: 0, conformance: "M", description: "Node is connected" }),
    Field({ name: "NotConnected", id: 1, conformance: "M", description: "Node is not connected" })
  ),
  Datatype(
    { name: "RoutingRoleEnum", type: "enum8", xref: { document: "core", section: "11.14.5.3" } },
    Field({ name: "Unspecified", id: 0, conformance: "M", description: "Unspecified routing role." }),
    Field({
      name: "Unassigned",
      id: 1,
      conformance: "M",
    ...
    Field({ name: "Reed", id: 4, conformance: "M", description: "The Node acts as an Router Eligible End Device." }),
    Field({ name: "Router", id: 5, conformance: "M", description: "The Node acts as a Router Device." }),
    Field({ name: "Leader", id: 6, conformance: "M", description: "The Node acts as a Leader Device." })
  ),
  Datatype(
