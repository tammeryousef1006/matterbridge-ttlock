...
const TimeSynchronization = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Unknown", id: 1, conformance: "M", description: "Node uses an unlisted time source." }),
    Field({
      name: "Admin",
      id: 2,
      conformance: "M",
    ...
    Field({ name: "Ptp", id: 15, conformance: "M", description: "Time synchronization comes from PTP." }),
    Field({ name: "Gnss", id: 16, conformance: "M", description: "Time synchronization comes from a GNSS source." })
  ),
  Datatype(
    {
    ...
    Field({ name: "Full", id: 0, conformance: "M", description: "Node has a full list of the available time zones" }),
    Field({
      name: "Partial",
      id: 1,
      conformance: "M",
    ...
    Field({ name: "None", id: 2, conformance: "M", description: "Node does not have a time zone database" })
  ),
  Datatype(
