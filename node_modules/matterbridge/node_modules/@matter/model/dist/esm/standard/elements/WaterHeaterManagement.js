...
const WaterHeaterManagement = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "Inactive", id: 0, conformance: "M", description: "Boost is not currently active" }),
    Field({ name: "Active", id: 1, conformance: "M", description: "Boost is currently active" })
  ),
  Datatype(
