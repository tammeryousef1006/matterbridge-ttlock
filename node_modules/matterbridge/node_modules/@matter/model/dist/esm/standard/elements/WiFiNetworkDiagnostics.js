...
const WiFiNetworkDiagnostics = Cluster(
  ...
  Datatype(
    ...
    Field({ name: "None", id: 1, conformance: "M", description: "Indicate the usage of no Wi-Fi security" }),
    Field({ name: "Wep", id: 2, conformance: "M", description: "Indicate the usage of WEP Wi-Fi security" }),
    Field({ name: "Wpa", id: 3, conformance: "M", description: "Indicate the usage of WPA Wi-Fi security" }),
    Field({ name: "Wpa2", id: 4, conformance: "M", description: "Indicate the usage of WPA2 Wi-Fi security" }),
    Field({ name: "Wpa3", id: 5, conformance: "M", description: "Indicate the usage of WPA3 Wi-Fi security" })
  ),
  Datatype(
  ...
  Datatype(
    ...
    Field({ name: "Unknown", id: 0, conformance: "M", description: "The reason for the failure is unknown." }),
    Field({ name: "AssociationFailed", id: 1, conformance: "M", description: "An error occurred during association." }),
    Field({
    ...
    Field({ name: "SsidNotFound", id: 3, conformance: "M", description: "The specified SSID could not be found." })
  ),
  Datatype(
    { name: "ConnectionStatusEnum", type: "enum8", xref: { document: "core", section: "11.15.5.4" } },
    Field({ name: "Connected", id: 0, conformance: "M", description: "Indicate the node is connected" }),
    Field({ name: "NotConnected", id: 1, conformance: "M", description: "Indicate the node is not connected" })
  )
);
