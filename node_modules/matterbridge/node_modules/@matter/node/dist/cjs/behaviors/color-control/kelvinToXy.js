...
var kelvinToXy_exports = {};
__export(kelvinToXy_exports, {
  kelvinToXyLookup: () => kelvinToXyLookup
});
module.exports = __toCommonJS(kelvinToXy_exports);
/**
 * @license
...
const lookupTable = {
  1e3: { x: 0.652750055750174, y: 0.34446222719737 },
  ...
  2e3: { x: 0.526676280311873, y: 0.41329727450763 },
  ...
  3e3: { x: 0.436929833678155, y: 0.404073616886221 },
  ...
  4e3: { x: 0.380438429420364, y: 0.376746069841299 },
  ...
  5e3: { x: 0.345100160725069, y: 0.35160700531884 },
  ...
  6e3: { x: 0.322082269887888, y: 0.331752126277376 },
  ...
  7e3: { x: 0.306372718718652, y: 0.316511125739794 },
  ...
  8e3: { x: 0.295186142428596, y: 0.304763622626521 },
  ...
  9e3: { x: 0.286924765725065, y: 0.295581717193809 },
  ...
  1e4: { x: 0.280632719756407, y: 0.288286029784579 },
  ...
  11e3: { x: 0.275714062105148, y: 0.282393589935205 },
  ...
  12e3: { x: 0.271782994107569, y: 0.277561259748537 },
  ...
  13e3: { x: 0.268581241076301, y: 0.273542778756921 },
  ...
  14e3: { x: 0.2659306955174, y: 0.270158905722483 },
  ...
  15e3: { x: 0.263705272809263, y: 0.267277169489418 },
  ...
  16e3: { x: 0.26181362112368, y: 0.264798161662946 },
  ...
  17e3: { x: 0.26018817532171, y: 0.262646185845289 },
  ...
  18e3: { x: 0.258778036270563, y: 0.260762802634035 },
  ...
  19e3: { x: 0.257544223554958, y: 0.259102312813239 },
  ...
  2e4: { x: 0.256456439408808, y: 0.257628552153879 }
};
function expandLookupTable() {
  for (const [kelvin, xy] of Object.entries(lookupTable)) {
    for (let i = 1; i < 10; i++) {
      lookupTable[parseInt(kelvin) + i] = xy;
    }
  }
}
function kelvinToXyLookup(kelvin) {
  if (!lookupTableExpanded) {
    expandLookupTable();
    lookupTableExpanded = true;
  }
  return lookupTable[Math.round(kelvin)];
}
