...
export declare namespace JointFabricDatastoreClusterInterface {
    interface Base {
        /**
...
export type JointFabricDatastoreClusterInterface = {
    components: [{
        flags: {};
        methods: JointFabricDatastoreClusterInterface.Base;
    }];
};
//# sourceMappingURL=JointFabricDatastoreClusterInterface.d.ts.map