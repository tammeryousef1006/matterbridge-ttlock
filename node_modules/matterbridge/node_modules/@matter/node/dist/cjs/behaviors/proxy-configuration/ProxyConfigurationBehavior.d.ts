 ...
 */
export declare const ProxyConfigurationBehavior: ClusterBehavior.Type<ProxyConfiguration.Cluster, typeof ClusterBehavior, {
    components: never[];
}>;
...
export declare namespace ProxyConfigurationBehavior {
    interface State extends StateType {
    }
}
export {};
//# sourceMappingURL=ProxyConfigurationBehavior.d.ts.map