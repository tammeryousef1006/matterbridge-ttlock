 ...
 */
export declare const ContentAppObserverBehavior: ClusterBehavior.Type<ContentAppObserver.Cluster, ClusterBehavior.Type<import("@matter/types").ClusterType.Of<{
    readonly id: 0;
    readonly revision: 0;
